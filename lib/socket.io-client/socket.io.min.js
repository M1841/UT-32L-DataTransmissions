    ...
    (r = [
          ...
          var t = i(t),
            ...
            o =
              e.forceNew || e["force new connection"] || !1 === e.multiplex || o
                ? (a("ignoring socket cache for %s", n), s(n, e))
                : (c[r] || (a("new io instance for %s", n), (c[r] = s(n, e))),
                  c[r]);
          return (
            t.query && !e.query && (e.query = t.query), o.socket(t.path, e)
          );
        }
        var i = n(1),
          o = n(7),
      ...
      function (t, e, n) {
        ...
        t.exports = function (t, e) {
          ...
          return (
            ...
            "string" ==
              typeof (t = null == t ? e.protocol + "//" + e.host : t) &&
              ("/" === t.charAt(0) &&
      ...
      function (r, o, i) {
        !function (e) {
          ...
          function t() {
            ...
            return (t = !t && void 0 !== e && "env" in e ? e.env.DEBUG : t);
          }
          var n =
      ...
      function (t, e) {
        ...
        function o(e) {
          ...
          if ((p === n || !p) && setTimeout) return (p = setTimeout)(e, 0);
          try {
            return p(e, 0);
          } catch (t) {
            try {
          ...
          function s() {
            if (s.enabled) {
              ...
              (o[0] = o[0].replace(/%([a-zA-Z%])/g, function (t, e) {
                ...
                return (
                  "function" == typeof e &&
                    ((n = o[i]), (t = e.call(r, n)), o.splice(i, 1), i--),
                  t
                );
              })),
      ...
      function (t, s, e) {
        ...
        function o(t, n) {
          f.removeBlobs(t, function (t) {
            var e = r((t = f.deconstructPacket(t)).packet);
      ...
      function (t, e, n) {
        function r(t) {
          if (t) {
            var e,
              n = t;
            for (e in r.prototype) n[e] = r.prototype[e];
            return n;
          }
        }
        ...
        (e.deconstructPacket = function (t) {
          ...
          return (
            (t.data = (function t(e, n) {
              ...
              var r;
              if (u(e))
                return (r = { _placeholder: !0, num: n.length }), n.push(e), r;
              if (h(e)) {
          ...
          (e.reconstructPacket = function (t, e) {
            return (
              (t.data = (function t(e, n) {
                ...
                if (h(e)) for (var r = 0; r < e.length; r++) e[r] = t(e[r], n);
          ...
          (r.prototype.open = r.prototype.connect =
            function (n, t) {
              ...
              return (
                !1 !== this._timeout &&
                  ((e = this._timeout),
                  h("connect attempt will timeout after %d", e),
                  0 === e && s.destroy(),
                  (r = setTimeout(function () {
                    h("connect attempt timed out after %d", e),
                      s.destroy(),
                      o.close(),
                      o.emit("error", "timeout"),
                      i.emitAll("connect_timeout", e);
                  }, e)),
                  this.subs.push({
                    destroy: function () {
                      clearTimeout(r);
      ...
      function (t, e, n) {
        ...
        t.exports = function (t) {
          ...
          try {
            if ("undefined" != typeof XDomainRequest && !n && t)
          ...
          "undefined" != typeof document &&
            ("function" == typeof attachEvent
              ...
              : "function" == typeof addEventListener &&
                ((t = "onpagehide" in n ? "pagehide" : "unload"),
                addEventListener(t, s, !1)));
      },
      function (t, e, n) {
        function r(t) {
        ...
        var o = n(21),
          ...
          h =
            ((t.exports = r),
            null != new (n(16))({ xdomain: !1 }).responseType);
        a(r, o),
      ...
      function (t, f, e) {
          ...
          if (!e) return f.encodeBase64Packet(t, n);
          {
            if (p) {
              var r = t,
                o = e,
                i = n;
              if (!o) return f.encodeBase64Packet(r, i);
              var s = new FileReader();
              return (
                (s.onload = function () {
                  f.encodePacket({ type: r.type, data: s.result }, o, !0, i);
                }),
                s.readAsArrayBuffer(r.data)
              );
            }
            return (
              ((e = new Uint8Array(1))[0] = y[t.type]),
              n(new m([e.buffer, t.data]))
            );
          }
        }
        function i(t, e, n) {
          for (
            var o = new Array(t.length), r = a(t.length, n), i = 0;
            i < t.length;
            i++
          )
            !(function (n, t, r) {
        ...
        (f.encodePacket = function (t, e, n, r) {
          ...
          if ("undefined" != typeof ArrayBuffer && o instanceof ArrayBuffer) {
            var i = t,
              s = r;
            if (!(a = e)) return f.encodeBase64Packet(i, s);
            var a = i.data,
              c = new Uint8Array(a),
              p = new Uint8Array(1 + a.byteLength);
            p[0] = y[i.type];
            for (var h = 0; h < c.length; h++) p[h + 1] = c[h];
            return s(p.buffer);
          }
          if (void 0 !== m && o instanceof m) return u(t, e, r);
          if (o && o.base64) return r("b" + f.packets[t.type] + t.data.data);
          a = y[t.type];
          return (
            void 0 !== t.data &&
              (a += n
          ...
          (f.decodePacket = function (t, e, n) {
            ...
            if ("string" == typeof t) {
              ...
              if (
                ...
                return g;
              var r = t.charAt(0);
              return Number(r) == r && h[r]
                ? 1 < t.length
                  ? { type: h[r], data: t.substring(1) }
                  : { type: h[r] }
                : g;
            }
            (r = new Uint8Array(t)[0]), (n = l(t, 1));
            return (
              m && "blob" === e && (n = new m([n])), { type: h[r], data: n }
            );
          }),
          (f.decodeBase64Packet = function (t, e) {
            ...
            return { type: n, data: (t = "blob" === e && m ? new m([t]) : t) };
          }),
      ...
      function (t, e) {
        ...
        function f() {
          if (d <= y) throw Error("Invalid byte index");
          var t = 255 & l[y];
          ...
          decode: function (t, e) {
            ...
            for (
              ...
              (r = (function (t) {
                ...
                if (192 == (224 & e)) {
                  if (128 <= (n = ((31 & e) << 6) | f())) return n;
                  throw Error("Invalid continuation byte");
                }
                if (224 == (240 & e)) {
                  if (2048 <= (n = ((15 & e) << 12) | (f() << 6) | f()))
                    return u(n, t) ? n : 65533;
                  throw Error("Invalid continuation byte");
                }
                if (
                  240 == (248 & e) &&
              ...
              o.push(r);
            for (var i, s = o, a = s.length, c = -1, p = ""; ++c < a; )
              65535 < (i = s[c]) &&
                ((p += g((((i -= 65536) >>> 10) & 1023) | 55296)),
                (i = 56320 | (1023 & i))),
                (p += g(i));
            return p;
          },
      ...
      function (t, e) {
        var r = [].slice;
        t.exports = function (t, e) {
          if ("function" != typeof (e = "string" == typeof e ? t[e] : e))
